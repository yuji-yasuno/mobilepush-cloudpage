...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let etAppId = "c496e8f6-c0dd-4b9a-a6d2-1843b8b975f4"
    let etAccessToken = "v53zg9yq4xsbznp3vjpwanqw"
    ...
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        ...
        ETPush.pushManager().setSubscriberKey("taskforce_cloudpage")
        ETPush.pushManager().addAttributeNamed("FirstName", value: "Taro")
        ETPush.pushManager().addAttributeNamed("LastName", value: "Yamada")
